            ...
            <form method="POST" action="input.php">
              <div class="col-md-6">
                ...
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" id="man" name="gender" value="0" <?php if (isset($_POST['gender']) && h($_POST['gender']) === '0') { echo 'checked'; } ?>>
                <label class="form-check-label" for="man">男</label>
                </div>
                <div class="form-check form-check-inline">
                  <input class="form-check-input" type="radio" id="woman" name="gender" value="1" <?php if (isset($_POST['gender']) && h($_POST['gender']) === '1') { echo 'checked'; } ?>>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="age">
                    ...
                    <option value="5"
                      <?php
                          if (isset($_POST['age']) && $_POST['age'] === '5') {
                          echo 'selected';
                          }
                      ?>
                    >35~
